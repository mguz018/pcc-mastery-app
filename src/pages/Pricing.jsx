...
export default function Pricing() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-5 py-16">
      <Seo
        title="Pricing"
        description="Unlock all 490 PCC exam practice questions. One-time access from $10.99 — 24-hour, 48-hour, or 1-week. No subscription."
        path="/pricing"
      />
      ...
      <div className="text-center mb-14">
        ...
        <p className="text-slate-600 dark:text-slate-400">
          Full access to all 490 questions. One-time payment — nothing recurring.
        </p>
      </div>
